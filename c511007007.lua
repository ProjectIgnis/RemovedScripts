...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		g1:GetFirst():RegisterFlagEffect(51107007,RESET_EVENT+RESETS_STANDARD,0,1,fid)
	end
	if Duel.GetLocationCount(1-tp,LOCATION_MZONE)>0
		...
		g2:GetFirst():RegisterFlagEffect(51107007,RESET_EVENT+RESETS_STANDARD,0,1,fid)
	end

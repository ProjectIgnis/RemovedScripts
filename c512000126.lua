--覇勝星イダテン
--Idaten the Conquer Star (Kachidoki)
local s,id=GetID()
function s.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(1040,8))
	...
	e3:SetDescription(aux.Stringid(1040,3))
	...
	c:RegisterEffect(e3)
	--What do you mean Xyz Monsters aren't Level 0!?
	local e4=Effect.CreateEffect(c)
	e4:SetType(EFFECT_TYPE_FIELD)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCode(EFFECT_RANK_LEVEL)
